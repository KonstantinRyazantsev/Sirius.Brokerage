...
namespace Brokerage.Bilv1.Repositories.DbContexts
{
    public class BrokerageBilV1Context : DbContext
    {
        public BrokerageBilV1Context(DbContextOptions<BrokerageBilV1Context> options) :
            base(options)
        {
        }
