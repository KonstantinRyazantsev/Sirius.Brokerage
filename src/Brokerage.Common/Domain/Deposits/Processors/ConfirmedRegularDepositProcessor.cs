...
{
    public class ConfirmedRegularDepositProcessor : IConfirmedTransactionProcessor
    {
        private readonly IOperationsFactory _operationsFactory;

        public ConfirmedRegularDepositProcessor(IOperationsFactory operationsFactory)
        {
        ...
        public async Task Process(TransactionConfirmed tx, TransactionProcessingContext processingContext)
        {
            ...
            await ProcessRegularDeposits(tx, processingContext);
        }

        private async Task ProcessRegularDeposits(TransactionConfirmed tx, TransactionProcessingContext processingContext)
        {
